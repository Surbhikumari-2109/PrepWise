      ...
      <div className="max-w-7xl mx-auto px-8 py-24 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <h1 className="text-6xl md:text-7xl font-bold leading-tight">
            ...
            Practice.
            <br />
            <span className="text-violet-400">Improve.</span>
          </h1>

          <p className="text-slate-400 mt-6 text-lg">
            AI-powered learning platform that helps students test their
            knowledge, track progress and climb leaderboards.
          </p>
        ...
        <div className="bg-slate-900/70 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 shadow-2xl">
          <h2 className="text-2xl font-semibold mb-6">Dashboard Preview</h2>
